(ns puppetlabs.jetty-trapperkeeper-experiment-web-core-test
  (:require [clojure.test :refer :all]
            [puppetlabs.jetty-trapperkeeper-experiment-service :as hello-svc]
            [puppetlabs.jetty-trapperkeeper-experiment-web-core :refer :all]
